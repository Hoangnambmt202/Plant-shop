    ...
    <div class="container pb-[1.5rem] xl:pb-10 lg:pb-10 md:pb-10 pt-14">
        ...
        <div class="flex flex-wrap mx-[-15px] mt-[-0px]">
            ...
            <!--/.row -->
                <div class="itemgrid grid-view projects-masonry shop mb-5">
                    ...
                    <div class="flex flex-wrap mx-[-15px] xl:mx-[-0px] lg:mx-[-0px] md:mx-[-0px] mt-[-0px] xl:mt-[-0px] lg:mt-[-0px] md:mt-[-0px] isotope">
                        ...
                        <?php
                            $photos = [];
                            if (is_string($pro->photo)) {
                                $photos = explode(',', $pro->photo);
                            } elseif (is_array($pro->photo)) {
                                $photos = $pro->photo;
                            }
                        ?>
                            <div style="padding:10px" class="project item group md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] xl:px-[10px] lg:px-[10px] md:px-[10px] px-[10px] mt-[10px] xl:mt-[10px] lg:mt-[10px] md:mt-[10px] max-w-full">
                                <div class="card">
                                    ...
                                    <div style="padding-left:10px; padding-right:10px" class="post-header">
          ...
          <aside class="hidden xl:block lg:block xl:w-3/12 lg:w-3/12 w-full flex-[0_0_auto] xl:px-[15px] lg:px-[15px] px-[15px] max-w-full sidebar mt-[0rem] xl:!mt-0 lg:!mt-0">
            <div class="">
            <?php echo $__env->make('frontend_tp2.layouts.catpromenu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
          </aside>
          <!-- /column .sidebar -->
        </div>
      ...
      <!-- /.container -->
</section><?php /**PATH D:\WORKSPACE_CODE\Flutter\Project\Plant-shop\backend\resources\views/frontend_tp/layouts/mod6pro.blade.php ENDPATH**/ ?>