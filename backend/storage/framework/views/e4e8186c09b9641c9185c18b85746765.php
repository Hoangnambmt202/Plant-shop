                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <div class="mt-2"> Mã: <span class="font-medium"><?php echo e($order->id); ?></span> </div>
                                    <div class="mt-1">Ngày lập: <?php echo e($order->created_at); ?></div>
                                    <div class="form-help">
                                        <?php echo e($order->created_at!=$order->updated_at?"Điều chỉnh: ".$order->updated_at:""); ?>
                                ...
                                <tr>
                                    ...
                                    <div >
                                        <div class="text-base text-slate-500">Khách hàng</div>
                                            <div class="mt-1">
                                                Họ và tên: 
                                                <span class="text-lg font-medium text-primary mt-2"><?php echo e($order->name); ?></span>
                                                
                                              
                                            </div>
                                            <div class="mt-1">SDT : <?php echo e($order->phone); ?></div>
                                            <div class="mt-1">Địa chỉ giao hàng: <?php echo e($order->shipping_address); ?></div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                    <div  >
                                        ...
                                        <div class="mt-1"><?php echo e(\App\Models\User::where('id',$order->vendor_id)->value('full_name')); ?>
                    ...
                    <div class="px-5 sm:px-16 py-5 sm:py-5">
                        <div class="overflow-x-auto">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php $i = 1;?>
                                    <?php $__currentLoopData = $orderProduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td> 
                                            <?php echo $i; $i ++; ?>
                                        </td>
                                        <td class="border-b dark:border-darkmode-400">
                                            ...
                                            <?php echo e(\App\Models\Product::where('id', $orderItem->product_id)->value('title')); ?>
                                        ...
                                        <td class="text-right border-b dark:border-darkmode-400 w-32">
                                            <?php echo e(number_format($orderItem->price, 0, '.', ',')); ?>

                                        </td>
                                        <td class="text-right border-b dark:border-darkmode-400 w-32  ">
                                        <?php echo e(number_format(($orderItem->quantity*$orderItem->price), 0, '.', ',')); ?>
                                ...
                                <tfooter>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <br/>
                                            <span class="font-medium "> 
                                                Phí vận chuyển: + <?php echo e($order->shiptrans_id? number_format(\App\Models\Freetransaction::find($order->shiptrans_id)->total,  0, '.', ','):'0'); ?>
                                    ...
                                    <div class="text-center sm:text-right sm:ml-auto" >
                                        <div class="text-base text-slate-500"> Đơn vị vận chuyển </div>
                                            <div class="text-xl text-primary font-medium mt-2">
                                               <?php echo e($order->delivery_id? \App\Models\User::find($order->delivery_id)->full_name:''); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORKSPACE_CODE\Flutter\Project\Plant-shop\backend\resources\views/backend/orders/show.blade.php ENDPATH**/ ?>