            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="text-center whitespace-nowrap">SĐT</th>
                        <th class="text-center whitespace-nowrap">ĐỊA CHỈ</th>
                        <th class="text-center whitespace-nowrap">PHƯƠNG THỨC GIAO HÀNG</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORKSPACE_CODE\Flutter\Project\Plant-shop\backend\resources\views/backend/orders/index.blade.php ENDPATH**/ ?>