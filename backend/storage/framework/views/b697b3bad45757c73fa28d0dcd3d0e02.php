...
<header class="relative wrapper bg-soft-primary !bg-[#edf2fc]">
          ...
          <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
            ...
            <div class="offcanvas-body xl:!ml-auto lg:!ml-auto flex  flex-col !h-full">
              <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                  <a class="nav-link  " href="<?php echo e(route('front.product.cat','laptop')); ?>" >Blog</a>
                </li>
                <li class="nav-item dropdown">
      ...
      <!-- /.offcanvas -->
    </header><?php /**PATH D:\WORKSPACE_CODE\Flutter\Project\Plant-shop-app\backend\resources\views/frontend_tp/layouts/header.blade.php ENDPATH**/ ?>