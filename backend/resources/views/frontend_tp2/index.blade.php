...
?>
@extends('frontend_tp2.layouts.master')
@section('head_css')
@endsection
@section('content')
        @if (env('DEMOAPP') == 1)
        ...
        @endif
        @include(('frontend_tp2.layouts.mode_slidebanner'))
        <!-- end top menu banner -->
        <!-- end blog-banner -->
        @include ('frontend_tp2.layouts.mod6pro')
        @include ('frontend_tp2.layouts.mod8randpro')
        @include('frontend_tp2.layouts.bannerpromo')
        @include ('frontend_tp2.layouts.mod8hotpro')
        <!-- end 8pro-righ-banner -->
        @include('frontend_tp2.layouts.mod_4_blog')
