<div class="flex flex-wrap mx-[-15px] items-center mb-10 !relative z-[1]">
                    <div class="md:w-7/12 lg:w-7/12 xl:w-8/12 w-full flex-[0_0_auto] px-[15px] max-w-full xl:pr-40">
                        <h2 class="text-[calc(1.265rem_+_0.18vw)] font-bold xl:text-[1.4rem] leading-[1.35] !mb-1">New Arrivals</h2>
                        <p class="mb-0 primarytextcolor">Showing 1–9 of 30 results</p>
                    </div>
                    <!--/column -->
