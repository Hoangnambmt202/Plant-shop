...
<html lang="en">
    <head>
        @include('frontend_tp.layouts.head')
        @yield('head_css')
    </head>
    <body class="[word-spacing:.05rem!important] font-Manrope text-[0.8rem] !leading-[1.7] font-medium">
     
    @include('frontend_tp.layouts.header')
    @include('frontend_tp.layouts.notification')
        @yield('content')
        @include('frontend_tp.layouts.footer')
        @include('frontend_tp.layouts.foot')
        @yield('scripts')
    </body>
</html>