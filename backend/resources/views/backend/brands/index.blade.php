...
@include('backend.layouts.notification')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('brand.create')}}" class="btn btn-primary shadow-md mr-2">Thêm nhà sản xuất</a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang {{$brands->currentPage()}} trong {{$brands->lastPage()}} trang</div>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="{{route('brand.edit',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
