...
@include('backend.layouts.notification')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('blogcategory.create')}}" class="btn btn-primary shadow-md mr-2">Thêm danh mục bài viết</a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang {{$blogcats->currentPage()}} trong {{$blogcats->lastPage()}} trang</div>
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="w-56 relative text-slate-500">
                    <form action="{{route('blogcategory.search')}}" method = "get">
                        @csrf
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        <td>
                            <a target="_blank" href="{{route('front.category.view',$item->slug)}}" class="font-medium whitespace-nowrap">{{$item->title}}</a> 
                        </td>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="{{route('blogcategory.edit',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
