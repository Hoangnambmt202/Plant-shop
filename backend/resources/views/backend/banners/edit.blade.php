            ...
            <form method="post" action="{{route('banner.update',$banner->id)}}">
                ...
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <input id="title" name="title" type="text" value="{{$banner->title}}" class="form-control" placeholder="title">
                    </div>
                    <div>
                        <label for="regular-form-1" class="form-label">Url</label>
                        <input id="url" name="url" type="text" value="{{$banner->url}}" class="form-control" placeholder="url">
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <select name="condition"   class="form-select mt-2 sm:mr-2"   >
                                ...
                                <option value = "ads" {{$banner->condition=='ads'?'selected':''}}>Promo</option>
                                <option value = "modpro" {{$banner->condition=='modpro'?'selected':''}}>modpro</option>
                            </select>
                        </div>
                    </div>
                    <div class="mt-3">
