                                ...
                                <tr>
                                    ...
                                    <div >
                                        <div class="text-base text-slate-500">Khách hàng</div>
                                            <div class="mt-1">
                                                Họ và tên: 
                                                <span class="text-lg font-medium text-primary mt-2">{{$order->name}}</span>
                                                
                                              
                                            </div>
                                            <div class="mt-1">SDT : {{$order->phone}}</div>
                                            <div class="mt-1">Địa chỉ giao hàng: {{$order->shipping_address}}</div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                    <div  >
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right border-b dark:border-darkmode-400 w-32  ">
                                        {{number_format(($orderItem->quantity*$orderItem->price), 0, '.', ',')}}
                                        </td>
                                    </tr>
                                    @endforeach
